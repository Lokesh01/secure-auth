  ...
  return (
    <div>
      ...
      <div className="relative max-w-3xl">
        <div className="steps-gradient dark:bg-gray-800 absolute top-0 h-[700px] w-[1.5px]"></div>

        <div className="flex flex-col gap-5">
          <div className="relative pl-6 transition duration-200 ease-in-out">
            <div className="bg-white dark:bg-background absolute -left-[9.5px] top-7 z-10 h-5 w-5 rounded-full">
